...
class PhotoPicker {
  ...
  PhotoPicker({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;
  ...
  Future<PhotoPickerResult> pickPhoto(PhotoPickerOptions arg) async {
    ...
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.PhotoPicker.pickPhoto', const StandardMessageCodec(), binaryMessenger: _binaryMessenger);
